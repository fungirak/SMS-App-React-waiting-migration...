...
const Politicas = () => {
  ...
  <h4 className="text-center mt-3  fw-normal p-2 shadow-lg rounded-pill">POLÍTICA DE PRIVACIDAD</h4>
    <div className="row mt-3 p-5">
      <p>
      <h4 className="text-center">POLÍTICA DE PRIVACIDAD DEL SITIO WEB</h4>
<h4 className="text-center">SMS APP by FUNGIRAK</h4>
<h5 className="mt-4">I. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS</h5>
<p style={{userSelect: "none"}}>Respetando lo establecido en la legislación vigente, SMS APP by FUNGIRAK (en adelante, también Sitio Web) se compromete a adoptar las medidas técnicas y organizativas necesarias, según el nivel de seguridad adecuado al riesgo de los datos recogidos.
...
Ley 25.326, relativo a la protección de los datos personales.
Identidad del responsable del tratamiento de los datos personales
Dirección: Santa Fe, Santa Fe, (Argentina)

Email de contacto: fungirak@gmail.com <br/>

Registro de Datos de Carácter Personal
En cumplimiento de lo establecido en las normativas vigentes, le informamos que los datos personales recabados por SMS APP by FUNGIRAK, mediante los formularios extendidos en sus páginas quedarán incorporados y serán tratados en nuestro fichero con el fin de poder facilitar, agilizar y cumplir los compromisos establecidos entre SMS APP by FUNGIRAK y el Usuario o el mantenimiento de la relación que se establezca en los formularios que este rellene, o para atender una solicitud o consulta del mismo. 
...
Las categorías de datos que se tratan en SMS APP by FUNGIRAK son únicamente datos identificativos. 

Base legal para el tratamiento de los datos personales
La base legal para el tratamiento de los datos personales es el consentimiento. SMS APP by FUNGIRAK se compromete a recabar el consentimiento expreso y verificable del Usuario para el tratamiento de sus datos personales para uno o varios fines específicos.
...
Los datos personales son recabados y gestionados por SMS APP by FUNGIRAK con la finalidad de poder facilitar, agilizar y cumplir los compromisos establecidos entre el Sitio Web y el Usuario o el mantenimiento de la relación que se establezca en los formularios que este último rellene o para atender una solicitud o consulta.

Igualmente, los datos podrán ser utilizados con una finalidad comercial de personalización, operativa y estadística, y actividades propias del objeto social de SMS APP by FUNGIRAK, así como para la extracción, almacenamiento de datos y estudios de marketing para adecuar el Contenido ofertado al Usuario, así como mejorar la calidad, funcionamiento y navegación por el Sitio Web.
...
Sin embargo, debido a que SMS APP by FUNGIRAK no puede garantizar la inexpugabilidad de internet ni la ausencia total de hackers u otros que accedan de modo fraudulento a los datos personales, el Responsable del tratamiento se compromete a comunicar al Usuario sin dilación indebida cuando ocurra una violación de la seguridad de los datos personales que sea probable que entrañe un alto riesgo para los derechos y libertades de las personas físicas. Se entiende por violación de la seguridad de los datos personales toda violación de la seguridad que ocasione la destrucción, pérdida o alteración accidental o ilícita de datos personales transmitidos, conservados o tratados de otra forma, o la comunicación o acceso no autorizados a dichos datos.
